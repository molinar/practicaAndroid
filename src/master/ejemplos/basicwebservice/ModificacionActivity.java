...
public class ModificacionActivity extends Activity {
	...
	public void stringToArray(String resultado) {
		try {
			...
			registros = Integer.parseInt(json.getJSONObject(0).getString(
					"NUMREG"));
			if (registros == 0) {
				volverMain();
			} else {
	...
	public void onBackPressed() {
		...
		Toast.makeText(this, "Modificación cancelada", Toast.LENGTH_LONG)
				.show();
		super.onBackPressed();
	}
	...
	public void terminar() {
		...
		Toast.makeText(this, "Modificación realizada", Toast.LENGTH_LONG)
				.show();
		finish();
	}
}
