...
public class MainActivity extends Activity {
	...
	public void conectar(View v) {
		if (dni.getText().length() > 8) {
			Toast.makeText(this, "El DNI introducido no es valido",
	...
	public void irInsertar(String respuesta) {
		try {
			...
			int registros = Integer.parseInt(json.getJSONObject(0).getString(
					"NUMREG"));
			...
			if (registros == 0) {
				...
				Toast.makeText(this, "El DNI introducido ya existe",
						Toast.LENGTH_LONG).show();
			}
		} catch (Exception e) {
			Log.e("BasicWebService", e.toString());
	...
	private class ConsultaDNIModificar extends
